...
# Get the base directory (on_prem folder)
base_dir = Path(__file__).resolve().parent

# Input and Output Paths (relative to on_prem)
input_path = base_dir / "data" / "raw" / "AB_NYC_2019.csv"
output_path = base_dir / "data" / "cleaned" / "AB_NYC_2019_cleaned.csv"
excel_path = base_dir / "data" / "cleaned" / "AB_NYC_2019_cleaned_by_neighbourhood.xlsx"
